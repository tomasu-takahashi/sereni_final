...
const professional0 = () => {
    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.container}>
            ...
            />
            <Text style={styles.title}>Mark T. Ortibano</Text>
          
              <Text style={styles.Text}>RPsy, RPm</Text>
              <Text style={styles.Text2}>Psychologist / Specialist, Assessment and Counseling Psychology</Text>
              <Text style={styles.Text3}>Clinics:</Text>
              <Text style={styles.Text4}>Saint Camillus Premium Health Care Services</Text>
              <Text style={styles.Text5}>Central City Walk Robinsons-Mandalagan, Bacolod City, Negros Occidental</Text>
