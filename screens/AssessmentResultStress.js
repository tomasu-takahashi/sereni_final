...
const AssessmentResultStress = ({ route, navigation }) => {
  ...
  if (totalScore >= 0 && totalScore <= 7) {
    ...
    result = 'Mild';
    message = "• Time management and organization:\n\nImplement strategies to manage your time effectively and avoid feeling overwhelmed.\n\n• Saying no:\n\nLearn to decline requests that add unnecessary stress to your schedule.\n\n• Identifying and avoiding triggers:\n\nRecognize situations or factors that tend to trigger your stress response and try to avoid them.\n\n• Journaling:\n\nWriting down your thoughts and feelings can help you process stress and gain perspective.\n\n• Seeking professional help:\n\nIf stress starts interfering with your daily life, consider seeking guidance from a therapist or counselor.";
    ...
    result = 'Moderate';
    message = "• Focus on maintaining basic self-care:\n\nEven if it feels challenging, prioritize regular meals, sleep, and hygiene.\n\n• Continue with activities from previous levels:\n\nKeep practicing relaxation techniques, time management, and identifying triggers.\n\n• Limit caffeine and alcohol:\n\nThese substances can exacerbate stress symptoms.\n\n• Consider physical therapy or massage:\n\nThese practices can help manage physical tension and improve relaxation.";
