...
const AssessmentResultStress = ({ route, navigation }) => {
  ...
  if (totalScore >= 0 && totalScore <= 18) {
    result = 'No Stress';
    message = "typically refers to a low level of stress or a state of tranquility and relaxation. It suggests that you are feeling relatively peaceful and composed, with minimal or manageable stressors affecting you at the moment. It's a positive state of mind where you can approach situations with a clear and focused mindset. However, it's important to note that stress levels can vary from person to person, and what may be calm for one individual might be different for another. It's always a good idea to listen to your own body and mind and take necessary steps to maintain your well-being.";
    recommendedActivities = '• Listen to Soothing Music:\nPut on calming music to relax and unwind.\n\n• Breathe Mindfully:\nPractice slow, deep breathing exercises.\n\n• Short Nature Walk:\nTake a leisurely walk in a nearby park or nature reserve.\n\n• Gentle Stretching:\nPerform light stretching exercises to relieve muscle tension.\n\n• Laugh:\nWatch a funny video or spend time with someone who makes you laugh.';
    bibleVerse = "\n\n• Psalm 34:4\nI sought the Lord, and he answered me; he delivered me from all my fears.\n\n• Psalm 23:2\nHe makes me lie down in green pastures, he leads me beside quiet waters.\n\n• Exodus 33:14\nThe Lord replied, 'My Presence will go with you, and I will give you rest.\n\n• Joshua 1:9\nHave I not commanded you? Be strong and courageous. Do not be afraid; do not be discouraged, for the Lord your God will be with you wherever you go.\n\n• Proverbs 17:22\nA cheerful heart is good medicine, but a crushed spirit dries up the bones.";

  } else if (totalScore >= 19 && totalScore <= 32) {
    result = 'Mild Stress';
    message = 'When referring to a Mild stress scale, it typically indicates a measurement or assessment of stress levels that are considered minimal or manageable. This scale is used to gauge the degree of stress experienced by an individual or a group.';
    ...
    message = "When referring to a severe stress scale, it typically indicates a high level of stress that significantly affects an individual's well-being and functioning. Severe stress is characterized by an overwhelming sense of pressure, emotional strain, and difficulty coping with the stressors at hand. It can have detrimental effects on both physical and mental health.";
    ...
    result = 'Dangerous';
    message = "Dangerous stress is often associated with chronic and overwhelming stressors that exceed an individual's capacity to cope effectively. It can lead to significant impairment in various areas of life, including work, relationships, and overall functioning. Prolonged exposure to dangerous levels of stress may increase the risk of developing physical and mental health problems, such as cardiovascular issues, anxiety disorders, depression, and burnout.";
    ...
    message = 'Extremely dangerous stress levels can lead to a number of serious health problems, including heart disease, stroke, diabetes, mental health problems, weakened immune system, obesity, and substance abuse. It can also lead to impaired judgment, risky behaviors, and accidents.';
    recommendedActivities = '• Drip Cold Water On Your Wrists:\nApplying cold water to your wrists and behind your earlobes can help calm your entire body during extremely high-stress moments.\n\n• Create a Zen Zone:\nSetting up a tranquil space for relaxation can be an essential tool for managing extreme stress.\n\n• Write It Down:\nJournaling your feelings can make them feel less overwhelming during moments of extreme stress.\n\n• Slurp Some Honey:\nConsuming honey can reduce inflammation in the brain, helping to fight depression and anxiety.\n\n• Talk to a Friend:\nSharing your feelings with a friend can provide emotional support and relief during periods of extreme stress.';
